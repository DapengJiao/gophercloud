...
func ListDs(client *gophercloud.ServiceClient, datastore string, version string) pagination.Pager {
	return pagination.NewPager(client, listDsURL(client, datastore, version), func(r pagination.PageResult) pagination.Page {
		return FlavorPage{pagination.LinkedPageBase{PageResult: r}}
	})
}
